...
$GLOBALS['TL_DCA']['tl_module']['palettes']['prosearch'] = '{title_legend},name,headline,type;{search_legend},psAutoCompletionType,psSearchCategories,perPage;{redirect_legend:hide},jumpTo;{template_legend:hide},customTpl;{protected_legend:hide:hide},protected;{expert_legend:hide},guests,cssID,space';

$GLOBALS['TL_DCA']['tl_module']['subpalettes']['psAutoCompletionType_simple'] = '';
$GLOBALS['TL_DCA']['tl_module']['subpalettes']['psAutoCompletionType_advanced'] = 'psAutoCompletionTemplate';
