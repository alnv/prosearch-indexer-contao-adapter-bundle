...
$GLOBALS['TL_LANG']['tl_indices']['protected_legend'] = 'Zugriffsschutz';
...
$GLOBALS['TL_LANG']['tl_indices']['protected'] = ['Index schützen', ''];
$GLOBALS['TL_LANG']['tl_indices']['groups'] = ['Mitgliedergruppen', ''];
...
$GLOBALS['TL_LANG']['tl_indices']['indices_strong'] = ['Strong', ''];
$GLOBALS['TL_LANG']['tl_indices']['indices_h1'] = ['H1', ''];
$GLOBALS['TL_LANG']['tl_indices']['indices_h2'] = ['H2', ''];
$GLOBALS['TL_LANG']['tl_indices']['indices_h3'] = ['H3', ''];
$GLOBALS['TL_LANG']['tl_indices']['indices_h4'] = ['H4', ''];
$GLOBALS['TL_LANG']['tl_indices']['indices_h5'] = ['H5', ''];
$GLOBALS['TL_LANG']['tl_indices']['indices_h6'] = ['H6', ''];
