...
$GLOBALS['TL_LANG']['tl_search_vector_files']['fields'] = ['Felder', 'Welche Felder sollen in der Vektordatei enthalten sein?'];
$GLOBALS['TL_LANG']['tl_search_vector_files']['file'] = ['Datei', ''];
$GLOBALS['TL_LANG']['tl_search_vector_files']['update'] = ['Vector Store aktualisieren', 'Vector Store aktualisieren'];